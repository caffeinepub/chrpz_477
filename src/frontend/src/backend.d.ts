...
export interface backendInterface {
    ...
    getChatUserSelectionList(): Promise<Array<UserSelection>>;
    getConversation(conversationId: bigint): Promise<Conversation | null>;
    getConversationMessages(conversationId: bigint, sinceMessageId: bigint | null): Promise<Array<ChatMessage>>;
