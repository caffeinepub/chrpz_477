...
import { ChatUserPickerModal } from "./components/ChatUserPickerModal";
...
export default function App() {
  ...
  const [chatWithPrincipal, setChatWithPrincipal] = useState<Principal | null>(
    null
  );
  ...
  const handleSelectChatUser = (principal: Principal) => {
    setShowChatPicker(false);
    setChatWithPrincipal(principal);
  };

  const handleCloseChatPicker = () => {
    setShowChatPicker(false);
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <TopHeader
          ...
          onOpenChat={handleOpenChatPicker}
        />
      ...
      {chatWithPrincipal && (
        <PrivateChatModal
          recipientPrincipal={chatWithPrincipal}
